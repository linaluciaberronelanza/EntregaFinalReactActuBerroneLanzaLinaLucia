# Tienda 3 L RENDER
Este es un proyecto corto y basico de un ecommerce, para un estudio de arquitectura que se especializa en imagenes en 3 dimensiones. La aplicacion permite ver productos basicos y realizar una compra. Los productos y las compras se almacenan en Firebase
